...
class Encoder(torch.nn.Module):
    def __init__(self, input_dim, output_dim):
        ...
        self.rnn = torch.nn.LSTM(input_dim, self.hidden_size, num_layers=1, bias=True,
...
class DecoderWithAttention(torch.nn.Module):
    def __init__(self, encoder_dim, decoder_dim, attn_dim, embed_dim, vocab_size):
        super(DecoderWithAttention).__init__()
        ...
        self.decode_step = torch.nn.LSTMCell(embed_dim, decoder_dim, bias=True)
    ...
    def forward(self, encoder_out, encoded_captions, caption_length):
        ...
        caption_length, sort_index = caption_length.squeeze(1).sort(dim=0, descending=True)
        ...
        decode_lengths = (caption_length - 1).to_list()
